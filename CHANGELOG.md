...
- Remediated CodeQL findings in credential encryption, avoiding staged
  wildcard-regex unescaping, and making XML entity decoding resistant to
  nested double-unescaping.
